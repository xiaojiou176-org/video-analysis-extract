...
describe("feed/jobs/artifacts pages", () => {
	...
	it(
		"renders artifacts with embedded screenshots and markdown",
		async () => {
	...
	it(
		"renders artifacts status when api returns empty payload",
		async () => {
	...
	it(
		"renders artifacts error alert on failure",
		async () => {

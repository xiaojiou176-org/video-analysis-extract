...
Usage:
  ...
  python scripts/probe_rsshub_health.py

  # Write best-N nodes back to RSSHUB_FALLBACK_BASE_URLS in .env:
  python scripts/probe_rsshub_health.py --write-env

  # Probe a custom list (overrides .env):
  python scripts/probe_rsshub_health.py --nodes "https://rsshub.app,https://hub.slarker.me"

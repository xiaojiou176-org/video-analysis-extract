...
```bash
./bin/reader-stack logs --env-file env/profiles/reader.env
./bin/reader-stack restart --env-file env/profiles/reader.env
./bin/reader-stack down --env-file env/profiles/reader.env
```
